...
public class PersonManager {
	...
	public static void main(String[] args) {
		...
		mg.fillPersons(persons);		
		
		mg.printTitle("인물정보 조회시스템");
		mg.showPerson(persons);		
		
		String message = String.format("성별 : %s (은)는   %d 명 입니다.", gender, mg.findByGender(persons, gender));
		System.out.println(message);
		
		mg.showPerson(persons, name);
